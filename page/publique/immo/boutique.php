...
$recherche = $db->query("SELECT * FROM produits WHERE type_produit LIKE 'Immo' ORDER BY id DESC " );
$recherche = $db->query("SELECT * FROM produits INNER JOIN boutique ON produits.id_boutique = boutique.id WHERE produits.type_produit LIKE 'Immo' ORDER BY produits.id DESC " );
$homme = 'Immo';
...
if(isset($_GET["recherche"]) AND !empty($_GET["recherche"])){
    ...
    $recherche = $db->query("SELECT * FROM boutique INNER JOIN  produits ON produits.id_boutique = boutique.id WHERE produits.type_produit LIKE 'Immo' and boutique.nom_boutique LIKE  '%$rech%'   ORDER BY produits.id DESC " );
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="info_article">
        <img src="photos-08.png" alt="">
        <h1>KEPHALÉ VOUS OFFRE LES MEILLIEUR <br> MAISSON DU MALI </h1>
    </section>
