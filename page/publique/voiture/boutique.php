...
$recherche = $db->query("SELECT * FROM produits WHERE type_produit LIKE 'voiture' ORDER BY id DESC " );
$recherche = $db->query("SELECT * FROM produits INNER JOIN boutique ON produits.id_boutique = boutique.id WHERE produits.type_produit LIKE 'voiture' ORDER BY produits.id DESC " );
$homme = 'voiture';
...
<body>
    ...
    <section class="info_article">
        <img src="photos-09.png" alt="">
        <h1>KEPHALÉ VOUS OFFRE LES MEILLIEUR <br> PARQUINE VOITURE</h1>
    </section>
